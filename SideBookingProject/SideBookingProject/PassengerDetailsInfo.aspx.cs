...
namespace BusBookingProject
{
    public partial class PassengerDetailsInfo : System.Web.UI.Page
    {
        ...
        protected void ButtonAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Вы не можете забронировать больше 3 линий'+'" + seatArray.Length + "')", true);
            }
        }
        ...
        private int getBook()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < seatArray.Length; i++)
                {
                    ...
                    sqlCmd.CommandText = "ispAddClientDetails";
                    sqlCmd.Connection = connString;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (resultcount ==-1)
            {
                string Msg = "Тупик забронирован, вы можете скачать чек ниже";
                Response.Redirect("BookingReport.aspx?Msg=" + Msg);
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Ошибка, Попробуйте еще раз')", true);
            }
        }
    }
}